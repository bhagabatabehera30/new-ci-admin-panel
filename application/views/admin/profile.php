        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="page-title-box">
                    ...
                    <div align="right">
                        <a href="#"><button type="button" class="btn-sm  btn btn-success"><i class="glyphicon glyphicon-arrow-left"></i> User Lists</button>    </a>
                ...
                <div class="col-md-3">
                  ...
                  <div class="box box-warning">
                    <div class="box-body box-profile">
                        <p style="text-align: center;"><img class="profile-user-img img-responsive img-circle" src="<?=CDN_PATH;?>UserImage/u_img.png" alt="User profile picture" style="margin-left: 25%;">
                        </p>
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="<?= ($active == "details")? "active" : "" ?> tab-pane" id="details">
                            <form action="<?=BASE_URL.ADMIN_PANEL; ?>profileUpdate" method="post" id="editProfile" role="form">
                        ...
                        <div class="<?= ($active == "changepass")? "active" : "" ?> tab-pane" id="changepass">
                            <form role="form" action="<?=BASE_URL.ADMIN_PANEL; ?>changePassword" method="post">
                                <div class="box-body">
                                    <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" 
                                    value="<?=$this->security->get_csrf_hash();?>" />
                                    <div class="row">
